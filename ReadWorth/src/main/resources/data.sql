...
-- 26. The Power of Now
MERGE INTO books (id, slug, title, author_name, cover_image, about_description, author_true_story, difficulty_level, length_label, language_tone, what_to_expect, how_not_to_judge, expected_outcome, expected_time_investment, our_rating, verdict, confidence_percentage, estimated_roi, created_at, updated_at)
KEY(id) VALUES (26, 'the-power-of-now', 'The Power of Now', 'Eckhart Tolle', 'https://m.media-amazon.com/images/I/71lY3y6uHIL._AC_UF1000,1000_QL80_.jpg', 'A guide to spiritual enlightenment that emphasizes living in the present moment.', 'Tolle was a deeply depressed graduate student at Cambridge when he had a profound spiritual transformation at age 29.', 'MODERATE', '236 pages', 'Spiritual, Meditative, Repetitive', 'Core concepts about the pain-body, the ego, and accessing the Now.', 'Do not expect a quick-fix self-help book. It requires genuine contemplation.', 'A fundamental shift in your relationship with thoughts and emotions.', 6.0, 4, 'CONDITIONAL', 80, 'Moderate - transformative for some, too abstract for others', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
MERGE INTO book_categories (book_id, category_id) KEY(book_id, category_id) VALUES (26, 4), (26, 2);
MERGE INTO book_verdict_reasons (book_id, reason) KEY(book_id, reason) VALUES (26, 'Life-changing for readers ready for spiritual concepts.'), (26, 'Can feel repetitive - the core message is delivered early.');
MERGE INTO external_links (id, book_id, label, url) KEY(id) VALUES (26, 26, 'Amazon', 'https://www.amazon.com/Power-Now-Enlightenment-Spiritual/dp/1577314808');

-- 27. 48 Laws of Power
MERGE INTO books (id, slug, title, author_name, cover_image, about_description, author_true_story, difficulty_level, length_label, language_tone, what_to_expect, how_not_to_judge, expected_outcome, expected_time_investment, our_rating, verdict, confidence_percentage, estimated_roi, created_at, updated_at)
KEY(id) VALUES (27, '48-laws-of-power', 'The 48 Laws of Power', 'Robert Greene', 'https://m.media-amazon.com/images/I/71aG+xDKSYL._AC_UF1000,1000_QL80_.jpg', 'A distillation of 3,000 years of power dynamics into 48 laws.', 'Greene was working as a magazine writer in Hollywood when he met a book packager who suggested he compile historical lessons on power.', 'CHALLENGING', '452 pages', 'Cynical, Historical, Dense', 'Each law is illustrated with historical examples and counter-examples.', 'Do not read it as a moral guide - it is descriptive, not prescriptive.', 'You will recognize power games being played around you in real time.', 12.0, 4, 'CONDITIONAL', 85, 'High - essential for understanding organizational politics', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
MERGE INTO book_categories (book_id, category_id) KEY(book_id, category_id) VALUES (27, 1), (27, 5);
MERGE INTO book_verdict_reasons (book_id, reason) KEY(book_id, reason) VALUES (27, 'Incredibly well-researched historical examples.'), (27, 'Morally ambiguous - use the knowledge defensively, not offensively.');
MERGE INTO external_links (id, book_id, label, url) KEY(id) VALUES (27, 27, 'Amazon', 'https://www.amazon.com/48-Laws-Power-Robert-Greene/dp/0140280197');

-- 28. Cant Hurt Me
MERGE INTO books (id, slug, title, author_name, cover_image, about_description, author_true_story, difficulty_level, length_label, language_tone, what_to_expect, how_not_to_judge, expected_outcome, expected_time_investment, our_rating, verdict, confidence_percentage, estimated_roi, created_at, updated_at)
KEY(id) VALUES (28, 'cant-hurt-me', 'Cant Hurt Me', 'David Goggins', 'https://m.media-amazon.com/images/I/81O7FcS1VpL._AC_UF1000,1000_QL80_.jpg', 'A memoir from a Navy SEAL who holds the world record for pull-ups and ran 100 miles on broken legs.', 'Goggins grew up in an abusive household, weighed nearly 300 pounds, and then transformed himself into one of the toughest men alive.', 'EASY', '364 pages', 'Aggressive, Motivational, Raw', 'Extreme stories of physical and mental endurance with actionable challenges.', 'Do not try to replicate his extreme methods without preparation.', 'A massive boost in mental toughness and refusal to quit.', 8.0, 5, 'YES', 92, 'Very High - pure adrenaline and motivation', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
MERGE INTO book_categories (book_id, category_id) KEY(book_id, category_id) VALUES (28, 4), (28, 5);
MERGE INTO book_verdict_reasons (book_id, reason) KEY(book_id, reason) VALUES (28, 'The most intense motivational book ever written.'), (28, 'Goggins story is genuinely unbelievable and inspiring.');
MERGE INTO external_links (id, book_id, label, url) KEY(id) VALUES (28, 28, 'Amazon', 'https://www.amazon.com/Cant-Hurt-Me-David-Goggins/dp/1544512287');

-- 29. 7 Habits of Highly Effective People
MERGE INTO books (id, slug, title, author_name, cover_image, about_description, author_true_story, difficulty_level, length_label, language_tone, what_to_expect, how_not_to_judge, expected_outcome, expected_time_investment, our_rating, verdict, confidence_percentage, estimated_roi, created_at, updated_at)
KEY(id) VALUES (29, '7-habits', 'The 7 Habits of Highly Effective People', 'Stephen R. Covey', 'https://m.media-amazon.com/images/I/71r0Xv+pSQL._AC_UF1000,1000_QL80_.jpg', 'A principle-centered approach for solving personal and professional problems through character ethics.', 'Covey developed these principles while earning his doctorate at BYU and teaching at Harvard Business School.', 'MODERATE', '381 pages', 'Principled, Systematic, Timeless', 'Seven sequential habits from dependence to independence to interdependence.', 'Do not skim it - each habit builds on the previous one.', 'A complete operating system for personal effectiveness.', 10.0, 5, 'YES', 94, 'Very High - foundational life framework', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
MERGE INTO book_categories (book_id, category_id) KEY(book_id, category_id) VALUES (29, 4), (29, 1);
MERGE INTO book_verdict_reasons (book_id, reason) KEY(book_id, reason) VALUES (29, 'Timeless principles that have worked for decades.'), (29, 'The Circle of Influence concept alone is worth the price.');
MERGE INTO external_links (id, book_id, label, url) KEY(id) VALUES (29, 29, 'Amazon', 'https://www.amazon.com/7-Habits-Highly-Effective-People/dp/1982137274');

-- 30. Mindset
MERGE INTO books (id, slug, title, author_name, cover_image, about_description, author_true_story, difficulty_level, length_label, language_tone, what_to_expect, how_not_to_judge, expected_outcome, expected_time_investment, our_rating, verdict, confidence_percentage, estimated_roi, created_at, updated_at)
KEY(id) VALUES (30, 'mindset', 'Mindset: The New Psychology of Success', 'Carol S. Dweck', 'https://m.media-amazon.com/images/I/71vZT5R+QnL._AC_UF1000,1000_QL80_.jpg', 'Stanford psychologist Carol Dweck reveals the difference between a fixed mindset and a growth mindset.', 'Dweck spent decades researching why some children give up when faced with challenges while others embrace them.', 'EASY', '320 pages', 'Research-backed, Accessible, Practical', 'Studies on children, athletes, and business leaders illustrating mindset differences.', 'Do not think it is just about trying harder - it is about believing you can improve.', 'You will catch yourself saying I cant and reframe it as I cant yet.', 7.0, 5, 'YES', 91, 'High - changes how you approach learning and failure', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
MERGE INTO book_categories (book_id, category_id) KEY(book_id, category_id) VALUES (30, 7), (30, 4);
MERGE INTO book_verdict_reasons (book_id, reason) KEY(book_id, reason) VALUES (30, 'Simple concept with profound implications across all life domains.'), (30, 'Essential reading for parents, teachers, and managers.');
MERGE INTO external_links (id, book_id, label, url) KEY(id) VALUES (30, 30, 'Amazon', 'https://www.amazon.com/Mindset-Psychology-Carol-S-Dweck/dp/0345472322');
